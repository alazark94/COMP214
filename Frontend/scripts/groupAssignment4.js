...
document.getElementById("job").addEventListener("change",()=>{
    document.getElementById("jTitle").value = document.getElementById("job").options[document.getElementById("job").selectedIndex].text;
...
document.getElementById("managerDropdown").addEventListener("change",()=>{
    document.getElementById("manID").value = document.getElementById("managerDropdown").value;
    
});

document.getElementById("dep").addEventListener("change",()=>{
    document.getElementById("deptIDField").value = document.getElementById("dep").value;
});